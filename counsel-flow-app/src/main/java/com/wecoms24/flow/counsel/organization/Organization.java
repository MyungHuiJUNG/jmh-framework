...
@Getter
@Setter
@Table(name = "ORGANIZATION_TM")
@AttributeOverride(name = "entityId", column = @Column(name = "ORG_EID"))
@JsonIgnoreProperties(ignoreUnknown =true)
public class Organization extends BaseAuditingUserIdSequenceAbstractEntity<Long> implements BaseTreeEntity<Organization, Long> {
    ...
    @JoinTable(name = "ORG_USERS",
    	joinColumns = @JoinColumn(name = "ORG_EID"),
    ...
    @Override
	public void addChild(List<Organization> children) {
		if (children != null) {
